...
public class DeviceRepair extends BaseEntity
{
    ...
    public String getOriginalResponsible() { return originalResponsible; }
    public void setOriginalResponsible(String originalResponsible) { this.originalResponsible = originalResponsible; }
    ...
    public Date getRepairTime() { return repairTime; }
    public void setRepairTime(Date repairTime) { this.repairTime = repairTime; }
    ...
    public String getHasParts() { return hasParts; }
    public void setHasParts(String hasParts) { this.hasParts = hasParts; }
    public String getPartsDesc() { return partsDesc; }
    public void setPartsDesc(String partsDesc) { this.partsDesc = partsDesc; }
}
